...
<div class="header">
	<div class="header-top">
		<div class="wrap">
			<div class="h-logo">
			<a href="index.php"><img src="images/PoPcOrN CiNeMaS.png" alt=""/></a>
		      </div>
			  <div class="nav-wrap">
...
<div class="block">
	<div class="wrap">
        ...
        <form action="" id="reservation-form" method="post" onsubmit="searchmovie()">
		       <fieldset>
		       	<div class="field" >
...
<script>
$("#search111").keyup(function searchmovie(){
    
var data={
    "search":$("#search111").val()
}
